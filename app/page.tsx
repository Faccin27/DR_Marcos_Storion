  ...
  return (
    <main className="flex min-h-screen flex-col items-center">
      ...
      >
        <div className="container px-4 md:px-6">
          <div className="mb-10 text-center">
            <h2 className="text-3xl font-bold text-[#2c3e50]">Antes e Depois</h2>
            <p className="mt-2 text-[#7f8c8d]">Resultados reais de procedimentos realizados pelo Dr. Marcos Storion</p>
            <p className="mt-1 text-xs text-[#95a5a6]">(Todas as imagens publicadas com autorização dos pacientes)</p>
          </div>
          ...
          <div className="grid gap-8 md:grid-cols-3">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <a href="#antes-depois" className="text-gray-300 hover:text-white">
                    Antes e Depois
                  </a>
                </li>
                <li>
