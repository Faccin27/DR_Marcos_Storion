...
import { Users, Award, Calendar, Smile, CheckCircle, Link } from "lucide-react";
        ...
        <div className="container px-4 md:px-6">
          ...
          <div className="mt-8 border-t border-gray-700 pt-8 text-center">
            <p className="text-sm text-gray-400">
              ...
              reservados. Feito por <a href="https://fixteam.uk" className="hover:text-gray-200">fixteam</a>.
            </p>
          </div>
        </div>
      </footer>
