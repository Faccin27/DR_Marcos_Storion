...
import { Users, Award, Calendar, Smile, CheckCircle, CodeXml } from "lucide-react"
...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center">
      ...
      <section className="w-full bg-white py-16">
        <div className="container px-4 md:px-6">
          <div className="grid grid-cols-2 gap-8 md:grid-cols-4">
            <AnimatedCounter end={10} label="Anos de Experiência" icon={<Calendar className="h-8 w-8" />} suffix="+" />
      ...
      {/* About Section */}
      <section id="sobre" className="w-full bg-gradient-to-t from-[#618fbd4d] to-white py-16">
        <div className="container px-4 md:px-6">
          <div className="grid gap-8 md:grid-cols-2">
            ...
            <div className="flex flex-col justify-center space-y-4">
              <h2 className="text-3xl font-bold text-[#2c3e50]">Sobre o Dr. Marcos Storion</h2>
              <p className="text-[#7f8c8d]">
                Com mais de 10 anos de experiência, Dr. Marcos Storion é especialista em cirurgia plástica estética e
                reparadora. Graduado em Medicina pela Universidade Estadual Paulista (UNESP), com uma formação de
                excelência, concluiu sua especialização em Cirurgia Plástica no renomado Instituto Dr. Ewaldo Bolivar de
                Souza Pinto
              </p>
              <div className="space-y-2">
                <div className="flex items-center gap-2">
                  <CheckCircle className="h-5 w-5 text-[#d4af37]" />
                  <span>Graduado em Medicina pela Universidade Estadual Paulista (UNESP)</span>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle className="h-5 w-5 text-[#d4af37]" />
                  <span>
                    Especializado em Cirurgia Plástica no renomado Instituto Dr. Ewaldo Bolivar de Souza Pinto
                  </span>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle className="h-5 w-5 text-[#d4af37]" />
              ...
              <div className="mt-4">
                <h3 className="mb-2 text-xl font-semibold text-[#2c3e50]">Destaque na Mídia</h3>
                <div className="grid grid-cols-3 gap-4 w-fit mx-auto md:mx-0">
                  <div className="overflow-hidden rounded-lg shadow-md">
                    <img src="/images/o_globo.jpg" alt="Entrevista na TV OGlobo" className="h-16 w-24 object-cover" />
                  </div>
                  <div className="overflow-hidden rounded-lg shadow-md">
                    <img src="/images/uol.png" alt="Revista uol" className="h-16 w-24 object-cover" />
                  </div>
                  <div className="overflow-hidden rounded-lg shadow-md">
                    <img src="/images/terra.jpg" alt="Terra" className="h-16 w-24 object-cover" />
                  </div>
                  <div className="overflow-hidden rounded-lg shadow-md">
                    <img src="/images/oglobo.jpg" alt="Terra" className="h-16 w-24 object-cover" />
                  </div>
                  <div className="overflow-hidden rounded-lg shadow-md">
                    <img src="/images/portal_ig.png" alt="Terra" className="h-16 w-24 object-cover" />
                  </div>
                  <div className="overflow-hidden rounded-lg shadow-md">
                    <img src="/images/valor.jpg" alt="Terra" className="h-16 w-24 object-cover" />
                  </div>
                </div>
              </div>
            </div>
      ...
      <section id="depoimentos" className="w-full bg-gradient-to-b from-[#618fbd4d] to-white py-16">
        <div className="container px-4 md:px-6">
      ...
      >
        <div className="container px-4 md:px-6">
          <div className="mb-10 text-center">
            <h2 className="text-3xl font-bold text-[#2c3e50]">Trabalhos Realizados</h2>
            <p className="mt-2 text-[#7f8c8d]">Conheça alguns dos procedimentos realizados pelo Dr. Marcos Storion</p>
          </div>
      ...
      <section id="contato" className="w-full bg-[#f8f9fa] py-16">
        <div className="container px-4 md:px-6">
          <div className="mb-10 text-center">
            <h2 className="text-3xl font-bold text-[#2c3e50]">Nossos Consultórios</h2>
        ...
        <div className="container px-4 md:px-6">
          <div className="grid gap-8 md:grid-cols-3">
            <div>
              ...
              <p className="text-gray-300">Cirurgião Plástico Especialista em Estética Facial e Corporal</p>
              <div className="mt-4 flex space-x-4">
                <a href="https://www.instagram.com/dr.marcos_storion" className="text-gray-300 hover:text-white">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <a href="#trabalhos" className="text-gray-300 hover:text-white">
                    Trabalhos
                  </a>
                </li>
                <li>
                  <a href="#depoimentos" className="text-gray-300 hover:text-white">
                    Depoimentos
                  </a>
                </li>
                <li>
          ...
          <div className="mt-8 border-t border-gray-700 pt-8 text-center">
            <p className="text-sm text-gray-400">
              © {new Date().getFullYear()} Dr. Marcos Storion. Todos os direitos reservados. Feito por{" "}
